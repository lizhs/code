...
// *
// */
//public class SendLengthPrefixProtocolEncoder extends MessageToMessageEncoder<ByteBuf> {
//	
...
//	 * @param encoding
//	 */
//	public SendLengthPrefixProtocolEncoder(int frameLength, String encoding, String padding) {
//		if (frameLength <= 0) {
